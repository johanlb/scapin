...
from src.frontin.api.models.journal import (
    AnswerRequest,
...
from src.frontin.api.services.journal_service import JournalService
from src.frontin.journal import JournalEntry
