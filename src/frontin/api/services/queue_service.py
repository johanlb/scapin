...
class QueueService:
    ...
    def _distribute_strategic_questions(self, item: dict[str, Any]) -> dict[str, list[str]]:
        ...
        Questions without target_note are collected for the briefing.
        ...
        Returns:
            ...
            and 'orphaned' (questions without target_note, for briefing)
        """
        from src.passepartout.note_manager import get_note_manager

        result = {"distributed": [], "orphaned": []}
        ...
        # Get email subject for traceability
        metadata = item.get("metadata", {})
        ...
        for sq in strategic_questions:
            ...
            if target_note:
                ...
                if success:
                    ...
                    # Target note not found - treat as orphaned
                    ...
                    logger.warning(
                        "Target note not found for strategic question",
                        extra={
                            "note_id": target_note,
                            "question": question[:50],
                        },
                ...
                # No target note - collect for briefing
                result["orphaned"].append({
                    "question": question,
                    "category": category,
                    "context": context,
