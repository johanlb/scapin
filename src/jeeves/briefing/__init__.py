...
Usage:
    from src.jeeves.briefing import BriefingGenerator, BriefingDisplay
...
from src.jeeves.briefing.display import BriefingDisplay
from src.jeeves.briefing.generator import (
