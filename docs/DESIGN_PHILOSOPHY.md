...
7. [Boucle d'Amélioration Continue](#7-boucle-damélioration-continue)
8. [Rythme Quotidien](#8-rythme-quotidien)
9. [Scalabilité et Multi-Instances](#9-scalabilité-et-multi-instances)
10. [Mesures de Succès](#10-mesures-de-succès)
11. [Anti-Patterns à Éviter](#11-anti-patterns-à-éviter)
12. [Références Théoriques](#12-références-théoriques)
...
### 7.1 Le Journaling comme Cœur du Système
...
### 7.4 Ce que le Journaling Alimente
...
### 8.1 Vision d'une Journée avec Scapin
...
## 9. Scalabilité et Multi-Instances

### 9.1 Architecture Moteur / Données
...
### 9.2 Cercles de Confiance Bidimensionnels
...
### 9.3 Communication Inter-Instances
...
### 11.2 Surcharge Informationnelle
...
### 11.5 Érosion de la Mémoire Biologique
...
2. **Intégration calendrier** : Comment Scapin interagit-il avec les événements calendrier ? Briefings automatiques ?

3. **Mode vocal** : Quelle place pour les dialogues audio (validation en voiture, briefing matin) ?

4. **Collaboration Damien** : Quand et comment mettre en place Scapin-Damien ?

5. **Clients Eufonie** : Scapin peut-il évoluer vers un produit pour les clients ?

6. **Mesures quantitatives** : Comment mesurer objectivement la réduction de charge mentale ?
